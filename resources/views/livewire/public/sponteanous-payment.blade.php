        ...
        <main class="container mx-auto px-4 py-12">
            <div class="max-w-4xl mx-auto">
                <div class="flex justify-center mb-8">
                    <div class="inline-flex items-center px-4 py-2 rounded-full text-sm
                    ...
                    <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 mb-10">
                        ...
                        @if ($this->transaction->status === 'paid')
                            ...
                            <div class="flex justify-center flex-wrap gap-4 mt-6">
                                <button class="bg-guiddini-accent hover:bg-guiddini-accent/80 text-white py-2 px-6 rounded-xl transition-all">Télécharger PDF</button>
                                <button class="bg-guiddini-accent hover:bg-guiddini-accent/80 text-white py-2 px-6 rounded-xl transition-all">Envoyer par Email</button>
                            </div>
                        @endif

                        <div class="mt-8 flex justify-center">
                            <button class="bg-gray-800 hover:bg-gray-900 text-white py-2 px-6 rounded-xl transition-all">Effectuer un nouveau paiement</button>
                        </div>
                    </div>
                @else
